...
public class AdminRestaurantController {
	...
	@Autowired
	private AdminRestaurantManager adminManger; 
	
	@RequestMapping("listPendingActive.htm")
	public ModelAndView listPendingRestaurant(final HttpServletRequest request,final ModelMap model) {
	...
	public ModelAndView saveCheckRestaurant(
