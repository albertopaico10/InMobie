...
public class ProviderDTO {
	...
	private String celphoneContact;
	...
	public String getCelphoneContact() {
		return celphoneContact;
	}
	public void setCelphoneContact(String celphoneContact) {
		this.celphoneContact = celphoneContact;
	}
