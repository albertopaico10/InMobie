						...
						<ul class="nav navbar-nav pull-right panel-menu">
							...
							<li class="dropdown"><a href="#"
								class="dropdown-toggle account" data-toggle="dropdown">
									<div class="avatar">
										<img src="${pageContext.request.contextPath}/resources/bootstrap/img/avatar.jpg" class="img-rounded" alt="avatar" />
								...
								<ul class="dropdown-menu">
									...
									<li><a href="ajax/calendar.html" class="ajax-link"> <i
											class="fa fa-tasks"></i> <span>Tasks</span>
									</a></li>
